<div class="min-h-screen bg-slate-800 flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        <div class="glass-effect rounded-3xl p-8 md:p-10 shadow-2xl">
            ...
            <!-- Error Message -->
            @error('email')
                <div class="mb-6 p-4 bg-red-500/20 border border-red-400/30 rounded-xl text-red-100 text-sm text-center">
                    {{ $message }}
                </div>
            @enderror
            ...
            <form wire:submit="login" class="space-y-4">
                ...
                <button type="submit"
                    class="w-full bg-slate-600 hover:bg-slate-500 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl shadow-slate-900/25 flex items-center justify-center gap-2">
                    <svg wire:loading wire:target="login" class="animate-spin -ml-1 mr-2 h-5 w-5 text-white"
